...
function updateTimerDisplayFromState() {
  ...
  console.log(`Updating timer display: remainingTime = ${remainingTime}`, state.current.serialize())
...
function updateUIFromState() {
  ...
  document.getElementById('pomodoro-count').textContent = state.current.cycleCount
}
